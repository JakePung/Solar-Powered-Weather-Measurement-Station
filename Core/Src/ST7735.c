...
//ChatGPT Code Below
 ...
 init_cmds2[] = {
    2,                        // 2 commands in list:
    ST7735_CASET, 4,          // Column address set, 4 args:
    0x00, 0x00,               // XSTART = 0
    0x00, 0x7F,               // XEND = 127
    ST7735_RASET, 4,          // Row address set, 4 args:
    0x00, 0x00,               // YSTART = 0
    0x00, 0xB3                // YEND = 179
};
#endif
...
#elif ST7735_IS_180x128
    _colstart = 0;  // Adjust these values if content is shifted
    _rowstart = 0;

    uint8_t data = 0x00; // Configure MADCTL for proper orientation
    ST7735_WriteCommand(ST7735_MADCTL);
    ST7735_WriteData(&data, 1);
